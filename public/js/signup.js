$(document).ready(() => {
	...
	function signUpUser(email, password,secondPasssword,userName,ageInput,policyVal) {
if(password !== secondPasssword){
  $('<div class="msg test">').appendTo("#alert").html('<p>Those passwords didn\'t match. Try again.</p>');
  $("#alert").fadeIn(500);
